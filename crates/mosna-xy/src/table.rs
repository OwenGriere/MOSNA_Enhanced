//! The assortativity table every one of its figures reads.
//!
//! The columns of `net_stat.csv` and one row of values per sample. Parsed once
//! here so each figure works from named blocks rather than re-deriving them
//! from column suffixes.
